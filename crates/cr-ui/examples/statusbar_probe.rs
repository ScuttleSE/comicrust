...
let _shell = shell.clone();
        ...
        glib::timeout_add_local(std::time::Duration::from_millis(5800), {
            ...
            move || {
                ...
                bar.update_lamps(cr_ui::library::is_scanning(), cr_ui::library::writes_pending() > 0, true, false, false, false);
                let export_on = bar.lamp_visible("export");
                let scan_on = bar.lamp_visible("scan");
                cr_ui::library::set_export_active(false);
                bar.update_lamps(false, false, false, false, false, false);
        ...
        glib::timeout_add_local(std::time::Duration::from_millis(7300), {
            ...
            move || {
                ...
                bar.update_lamps(true, false, false, false, false, false);
        ...
        glib::timeout_add_local(std::time::Duration::from_millis(8600), {
            ...
            move || {
                ...
                bar.update_lamps(false, false, false, cr_ui::library::cv_job_active(), false, false);
                bar.set_cv_job_text(
        ...
        glib::timeout_add_local(std::time::Duration::from_millis(8400), {
            ...
            move || {
                ...
                bar.update_lamps(false, false, false, false, true, false);
